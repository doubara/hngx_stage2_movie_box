    ...
    return <div className="min-h-full text-black px-6 py-6">
        ...
        <div className="flex md:flex-col items-stretch">
            <div className="basis-3/4 px-4 text-black">
                ...
                <p className='my-2'>Production: {movie?.production_companies?.map((company, index)=>{
                    return <span key={index*Math.random()*750} className='px-2 text-red-400'>{company.name}</span>
                })}</p>
